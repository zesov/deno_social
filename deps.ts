...
export type { ExecuteResult } from "https://deno.land/x/mysql@v2.11.0/src/connection.ts";
export type { TransactionProcessor } from "https://deno.land/x/mysql@v2.11.0/src/client.ts";
